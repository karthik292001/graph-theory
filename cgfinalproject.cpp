...
glEnd();
	...
	bitmap_output(width/15+10,height-height/1.9,"Karthik M C",GLUT_BITMAP_HELVETICA_18);
	bitmap_output(width/15+10,height-height/1.7,"Jai Ganesh",GLUT_BITMAP_HELVETICA_18);
	bitmap_output(width/15+10,height-height/1.55,"Karthik",GLUT_BITMAP_HELVETICA_18);
	bitmap_output(width/15+10,height-height/1.42,"Hithaish N",GLUT_BITMAP_HELVETICA_18);
	glColor3f(0.0,0.0,0.0);
